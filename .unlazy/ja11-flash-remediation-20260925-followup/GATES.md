...
- [x] G6: no production correction is justified; focused regression fixtures are present, while local execution is NOT RUN and current-source CI remains the applicable remote gate.
