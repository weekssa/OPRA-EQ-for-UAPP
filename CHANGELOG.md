...
- These follow-up edits are a new source candidate; Android/domain/repository/UI/emulator, lint/R8, CodeQL, workflow, catalog/community, dependency, signing, checksum/artifact, install/cold-launch gates have not passed on that new source yet. No corrected signed APK is available, and no physical test is requested.
