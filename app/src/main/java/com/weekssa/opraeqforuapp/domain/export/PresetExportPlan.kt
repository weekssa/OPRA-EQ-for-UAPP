                    ...
                    profile.generatedXml?.let { xml ->
                        ...
                        add(
                            PresetExportCandidate(
                                ...
                                deviceName = ExportDevice.UAPP.displayName,
                    ...
                    .forEach { variant ->
                        ...
                        add(
                            PresetExportCandidate(
                                ...
                                xml = variant.content,
                                generatedFingerprint = "$fingerprint:${variant.device.name}:v${variant.representationVersion}",
                                contentHash = sha256(variant.content.toByteArray(charset)),
                                mimeType = variant.device.mimeType,
                                charsetName = charset.name(),
                                deviceName = variant.device.displayName,
