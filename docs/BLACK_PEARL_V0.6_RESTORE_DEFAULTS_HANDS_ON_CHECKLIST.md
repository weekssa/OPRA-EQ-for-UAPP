...
Status: **CORRECTIVE BETA — physical retest required after 431cbfa failure.**
...
Current gate: new exact-source Android CI, CodeQL, catalog currentness, priority community coverage, and signed-beta provenance, then focused Pixel 9 testing. No physical PASS is claimed for the correction. PR #16 stays open/draft/unmerged; public release remains v0.5.0.
