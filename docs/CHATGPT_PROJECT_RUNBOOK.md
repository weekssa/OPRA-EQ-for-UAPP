...
Do not repeat Flash, exact restoration, Apply, Reset, or E001 Save qualification. Personal EQ capture is not evidenced by these operation reports. The latest verified signed head before this documentation-only synchronization is `2f99bc7bf183a556bbe9466266abb44cdc02079b` (workflow #1305); this synchronization changes documentation only and requires fresh current-head gates. Physical E037-E040 on source 381 already record verified Flash, exact-baseline Restore, Apply, and Reset. Personal EQ capture remains unevidenced by these reports. Keep PR #23 draft, keep v0.7.0 NO-GO, and require explicit owner approval before merge/publication/public support.
