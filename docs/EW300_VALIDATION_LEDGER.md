...
The replacement signed candidate at `8bb87aac689ce28b1e92e115a3f83f1b59ad1f65` passed the
...
`EQ-Library-signed-beta-8bb87aac689ce28b1e92e115a3f83f1b59ad1f65`.
...
gate. The smallest review action is to inspect whether the `DEVICE_GLOBAL_GAIN` mapping, targeted
apply test, exact candidate provenance, and no-write stop evidence preserve the no-replay and
