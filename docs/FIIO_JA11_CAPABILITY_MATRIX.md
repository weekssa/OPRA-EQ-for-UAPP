...
The latest owner-tested signed candidate is source `5b4b40bfccabae91e3839de9ff2f7b1edcb0d67a` with
immutable APK SHA-256 `847e2ed07b2373aa17c2feb026a843081123bae00882d777bdb43222375a4049`, signer
certificate SHA-256 `65c1c1256dae3c49e3548f334c91f0ba991969e9be9e0b223ba4e253d2114747`, and signed-beta
run [#1364](https://github.com/weekssa/OPRA-EQ-for-UAPP/actions/runs/36197533476). Its exact physical
negative result is recorded as J012 in the ledger below. The earlier signed candidate was source
`609911e2e51a254fc6f45b87fbdf4106c0049740` with
...
| Complete baseline capture and failed-operation restoration | BASELINE PROVEN; RESTORATION PENDING | J012 contains the complete pre-write program, global gain, and five-band baseline and the complete post-Apply target readback. It does not contain a post-operation restoration or persistence result. No automatic retry or restoration mutation is added. |
...
The latest J011 owner session is consumed and recorded as J012. There is no safe reason to repeat
that mutation. Do not convert J012 into a protocol change, tolerance change, retry, or support
claim without evidence that distinguishes stale response, firmware transformation, packet
semantics, timing, and intended-value errors. A future physical session requires a new exact
candidate and a bounded owner-approved plan after a software/protocol decision is proven.
