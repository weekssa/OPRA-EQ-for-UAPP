...
class GithubCommunityIngestTest(unittest.TestCase):
    def test_valid_public_peq_publishes_as_unverified(self):
    ...
    def test_missing_preamp_remains_null(self):
        ...
        self.assertTrue(success)
        new_profile = next(profile for profile in merged["profiles"] if profile["creator"] == "listener")
